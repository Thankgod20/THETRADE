...
$(document).ready(function() {
    $('.form').submit(function(e) {
        ...
        $.ajax({
              url: "../db/update.php",
              type:'post',
              data:({bill:1,email:user,amount:pass}),
                ...
                <div class="col-md-6">
                    ...
                    <div align="center" class="lbdy">
                        ...
                        <form action="../db/login.php" method="post" class="form">
                            ...
                            <br>
                            <input type="text" name="pass" class="pass" placeholder="Enter Message">
                            <br>
                            <br>
                            <br>
                            <button type="submit" name="sub" class="sub">Bill</button>
                        </form>
                        <hr>
                        <br>
