...
<head>
    ...
    <title>SMARTBUZZCRYPTO | TRADES</title>
...
$(document).ready(function() {
  ...
  updateP();
    function updateP() {
      ...
      //alert(key)
        var output = "<li class='pftList'><div class='row'><div class='col-md-3 vpl'>"+value.pair+"</div><div class='col-md-3 cprix'>"+value.cprice+"</div><div class='col-md-3 camtx'>"+value.amount+"</div><div class='col-md-3 pst'>"+value.position+"</div></div></li>";
        $(".opnpp").append(output);
        ...
        <div class="bg-light p-5 rounded">
          <div class="row">
            ...
            <ul class="" style="color:white">
              <li class=''>
                <div class='row'>
                  <div class='col-md-3'>PAIR</div>
                  <div class='col-md-3'>TRADED PRICE</div>
                  <div class='col-md-3'>LOT</div>
       
                  <div class='col-md-3 pst'>BUY/SELL</div>
