...
`<div class="row">
	...
	<div id="orderb" class="order-book col-md-6" style="border: 1px solid #2a2e3a;">
		<ul style="background-color: #131722;">
			<li id=""" class="bid">TRADES FEEDS</li>
			<li id="" class="">Price    <span id="lots-eight">Volume</span></li>
			<li id="eight-t" class="bids">18960.79000000<span id="lots-eight"></span></li>
			<li id="seven-t" class="bids">18960.79000000<span id="lots-seven"></span></li>
			<li id="six-t" class="bids">18960.79000000<span id="lots-six"></span></li>
			<li id="five-t" class="bids">18960.79000000<span id="lots-five"></span></li>
			<li id="four-t" class="asks">18960.79000000<span id="lots-four"></span></li>
			<li id="three-t" class="asks">18960.79000000<span id="lots-three"></span></li>
			<li id="two-t" class="asks">18960.79000000<span id="lots-two"></span></li>
			<li id="one-t" class="asks">18960.79000000<b id="lotsone"></b></li>
...
<div class="row">
	<style>
		...
		li {display:block; font-size:10px}
		.asks{color:red !important}
		.bids{color:#499a82 !important}
	</style>
	<div class="plot-place col-md-4" style="border: 1px solid #2a2e3a;">
	<script src="https://code.highcharts.com/highcharts.js"></script>

	<div id="container" style="height: 500px; min-width: 310px;width:50%;height: 50vw;transform: rotate(-90deg)"></div>
		
	</div>
	<div id="orderb" class="order-book col-md-8" style="border: 1px solid #2a2e3a;">
	<ul style="background-color: #131722;">
		<li id=""" class="bid" align="center">ORDER BOOKS</li>
		<li id="eight" class="bids">18960.79000000<span id="lots-eight"></span></li>
		<li id="seven" class="bids">18960.79000000<span id="lots-seven"></span></li>
		<li id="six" class="bids">18960.79000000<span id="lots-six"></span></li>
		<li id="five" class="bids">18960.79000000<span id="lots-five"></span></li>
		<li id="" align="center">BIDS PRICE</li>
		<hr>
		<li id="mid-price"" class="bid">Loading..</li>
		<hr>
		<li id="" align="center">ASKS PRICE</li>
		<li id="four" class="asks">18960.79000000<span id="lots-four"></span></li>
		<li id="three" class="asks">18960.79000000<span id="lots-three"></span></li>
		<li id="two" class="asks">18960.79000000<span id="lots-two"></span></li>
		<li id="one" class="asks">18960.79000000<b id="lotsone"></b></li>
...
const updtwtclst = (watcJson) =>{
	for (let i =0; i<watcJson.length;i++) {
		if (JSON.stringify(watcJson[i].s).search("USDT")>-1)
		{
			...
			<div class="row">
			  <div class="col-4"><span style="color: white;">`+watcJson[i].s+`</span></div>
...
const trades ='wss://stream.binance.com:9443/ws/btcusdt@trade';
...
socktrades.onmessage = function(event) {
	...
	if (liLen<10) {
		...
		document.getElementById("feeds").prepend(li)//('<li id="eight-t" class="bids">'+feeds.p+'<span id="lots-eight">'+feeds.q+'</span></li>')
	} else {
